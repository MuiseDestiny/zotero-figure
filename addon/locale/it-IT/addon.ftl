...
reader-menu-add-to-figure = Aggiungi a Figure
progress-add-to-results = Aggiunta delle annotazioni immagine ai risultati dell'analisi…
progress-add-to-results-done = Aggiunte { $created } annotazioni immagine ({ $skipped } già presenti)
...
batch-progress-no-annotations = Nessuna annotazione immagine selezionata
batch-progress-import-done = Importate { $created } annotazioni immagine ({ $skipped } già presenti), non riuscite { $failed }
...
prompt-figure-caption = Didascalia della figura:
