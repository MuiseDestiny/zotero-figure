...
await addon.reload();
const progressWindowKey = "__zoteroFigureHotReloadProgressWindow";
Zotero[progressWindowKey]?.close();
const progressWindow = new Zotero.ProgressWindow({ closeOnClick: true });
Zotero[progressWindowKey] = progressWindow;
...
progressWindow.show();
progressWindow.startCloseTimer(1500);
setTimeout(() => {
    if (Zotero[progressWindowKey] === progressWindow) {
        Zotero[progressWindowKey] = undefined;
    }
}, 1500);
})()`;
